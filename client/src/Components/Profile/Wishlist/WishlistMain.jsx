...
<div className="mt-2 py-2">
    ...
    <div className="border-2 h-40vh mt-4 rounded-xl">
        <div className="my-6 flex items-center justify-between border-b-2 mx-10 pb-2">
            <span>
                <span className="flex">
                    <h1 className='font-bold '>Status: </h1>  <h3 className='font-bold text-green-600 px-2'>Starting Soon</h3>
                </span>
                <span className="flex">
                    <h1 className='font-semibold text-gray-600 '>Date: 16 December 2023 </h1> 
                </span>
            </span>
            <div >
                <button className='px-4 h-8 border-2 border-red-700 hover:bg-red-700 hover:text-white font-semibold text-red-700'>Remove</button>
                <button className='px-4 mx-2 h-8 border-2 border-blue-700 font-semibold bg-green-700 hover:bg-green-900 text-white'>Do Bid</button>
    ...
    <div className="border-2 h-40vh mt-4 rounded-xl">
        <div className="my-6 flex items-center justify-between border-b-2 mx-10 pb-2">
            <span>
                <span className="flex">
                    <h1 className='font-bold '>Staus: </h1>  <h3 className='font-bold text-red-600 px-2'>Closed</h3>
                </span>
                <span className="flex">
